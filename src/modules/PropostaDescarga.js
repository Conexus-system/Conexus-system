...
export default function PropostaDescarga({ onBack }) {
      ...
      <div style={{background:"#1e2028",padding:"10px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",position:"sticky",top:0,zIndex:100}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <div style={{borderLeft:"1px solid #333",paddingLeft:10}}>
            <div style={{fontSize:12,color:"#eee",fontWeight:600}}>Proposta Descarga</div>
        ...
        <div style={{background:W,borderRadius:6,boxShadow:"0 2px 20px #0003"}}>
          ...
          <div style={{padding:"20px 28px"}}>
            ...
            <div style={{marginBottom:16,fontSize:12}}>
              ...
              <p style={{marginTop:8}}>É com satisfação que apresentamos a V. Sas., nossas condições técnicas e comerciais para a execução dos serviços de <strong>descarga / transferência</strong>, conforme as condições abaixo descritas:</p>
            </div>

            <div style={{marginBottom:12,fontSize:12}}>
              <div style={{fontWeight:700,marginBottom:6}}>- ESCOPO DO SERVIÇO:</div>
              <p>Serviços de descarga, movimentação e transferência de cargas ou equipamentos, conforme a planilha do item preços.</p>
            </div>
