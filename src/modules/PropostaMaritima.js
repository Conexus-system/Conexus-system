...
const defaultFrete = [
  { taxa:"Frete marítimo", moeda:"EUR", valor:"555,00", un:"cntr", qtde:"1", total:"" },
  { taxa:"EFS", moeda:"EUR", valor:"199,00", un:"cntr", qtde:"1", total:"" },
  { taxa:"EX Works", moeda:"EUR", valor:"935,00", un:"cntr", qtde:"1", total:"" },
  { taxa:"Handling Origem", moeda:"EUR", valor:"100,00", un:"processo", qtde:"1", total:"" },
  { taxa:"ETS", moeda:"EUR", valor:"232,00", un:"cntr", qtde:"1", total:"" },
];
const defaultOrigem = [];
const defaultDestino = [
  { taxa:"BL Fee",                   moeda:"BRL", valor:"420,00",  un:"BL",      qtde:"1", total:"" },
  { taxa:"Capatazia",                moeda:"BRL", valor:"1.130,00",un:"cntr",    qtde:"1", total:"" },
  { taxa:"Container Service Charge", moeda:"BRL", valor:"195,00",  un:"cntr",    qtde:"1", total:"" },
  { taxa:"Desconsolidação",          moeda:"USD", valor:"100,00",  un:"BL",      qtde:"1", total:"" },
  { taxa:"Import Service Charge",    moeda:"USD", valor:"30,00",   un:"cntr",    qtde:"1", total:"" },
  { taxa:"Seguro Internacional",     moeda:"EUR", valor:"873,56",  un:"processo",qtde:"1", total:"" },
  { taxa:"TRS",                      moeda:"USD", valor:"30,00",   un:"BL",      qtde:"1", total:"" },
  { taxa:"IOF",                      moeda:"EUR", valor:"70,74",   un:"processo",qtde:"1", total:"" },
  { taxa:"Handling",                 moeda:"USD", valor:"100,00",  un:"processo",qtde:"1", total:"" },
];
...
export default function PropostaMaritima({ onBack }) {
  const [hdr, setHdr] = useState({
    cotacao:"CP251198", tipo:"IMPORTAÇÃO",
    cliente:"", cnpj:"", data: new Date().toLocaleDateString("pt-BR"),
    incoterm:"EXW", coleta:"", origem:"Miami", destino:"",
    volume:"", pesoBruto:"", pesoTaxado:"",
    transit:"28 - 31 dias aprox.", rota:"PTM / SSA", frequencia:"Semanal",
      ...
      <div style={{background:"#1e2028",padding:"10px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",position:"sticky",top:0,zIndex:100}}>
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          <div style={{borderLeft:"1px solid #333",paddingLeft:10,marginLeft:4}}>
            <div style={{fontSize:12,color:"#eee",fontWeight:600}}>Proposta Marítima</div>
      ...
      <div style={{maxWidth:950,margin:"0 auto",padding:"20px 16px"}} id="proposta-print">
        <div style={{background:W,borderRadius:6,boxShadow:"0 2px 20px #0003",overflow:"hidden"}}>
          ...
          <div style={{padding:"14px 24px"}}>
            ...
            {/* TAXAS ORIGEM */}
            <TaxaTable title="TAXAS DE ORIGEM (LOCAIS)" rows={origem} setter={setOrigem}
